...
class UpdatePasswordForm(Form):
    ...
    current_password = PasswordField(u'当前密码', validators=[DataRequired(message=u'请输入当前密码')])
    password = PasswordField(u'新的密码', validators=[InputRequired(message=u'请输入新密码'), EqualTo('confirm',message=u'确认密码不匹配。')])
    confirm = PasswordField(u'确认密码',validators=[InputRequired(message=u'请再次输入新密码')])