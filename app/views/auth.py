...
from flask import Module, Blueprint
...
@auth.route('/addauth/', methods=['GET', 'POST'])
@login_required
def add_auth():
...
@auth.route('/queryauth/')
@auth.route('/queryauth/<int:page>/')
@login_required
